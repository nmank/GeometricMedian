...
def heatmap(data, row_labels, col_labels, colorbar=False, ax=None, cbar_kw={}, cbarlabel="", **kwargs):
    """
...
def method_comparison_plot(data, true_labels, k_means_centers, lbg_centers):
    ...
    plt.plot(embed[-l:, 0], embed[-l:, 1], 'o', markersize=8, markeredgecolor='k', label='LBG Centers')
    plt.plot(embed[-(k+l):-l, 0], embed[-(k+l):-l, 1], 'o', markersize=8, markeredgecolor='k', label='K-means Centers')
    plt.legend()
